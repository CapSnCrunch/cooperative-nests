...
#c1 = 1 # Ratio of survival rate of S to C queens (used in queen fights within clusters)
#c2 = 1 # Ratio of contribution of S to C queens (not currently used)
#c3 = 1 # Ratio of reproductive capabilities of S to C queens (used in reproduction)
sc = 0.5 # Survival rate of C queens (used in queen fights within clusters)
...
save_file = 'steady_states.dat' # Specify where we want to save the data
...
if __name__ == '__main__':
    ...
    for c1 in np.linspace(0, 1, 4):
        for c2 in np.linspace(0, 1, 4):
            for c3 in np.linspace(0, 1, 4):
